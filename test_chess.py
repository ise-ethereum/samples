...
# general tests should all be checked by the sanity check
    def test_moving_outside_the_field(self):
        self.assertFalse(self.test_black.make_move(4,-1,Chess.Player.BLACK))

    def test_taking_a_figure_outside_the_field(self):
        self.assertFalse(self.test_black.make_move(-1,4,Chess.Player.BLACK))

    def test_basic_move_king_own_figure(self):
        self.assertFalse(self.test_black.make_move(4,20,Chess.Player.BLACK))

    def test_wrong_player_moves(self):
        self.assertFalse(self.test_black.make_move(4,5,Chess.Player.WHITE))
...
#test for bishop
    ...
    def test_move_bishop_invalid(self):
        ...
        # simply wrong move
        self.assertFalse(self.test_black.make_move(20,64,Chess.Player.BLACK))
...
# test for pawn
    ...
    def test_move_pawn_invalid(self):
        ...
        self.assertFalse(self.test_white.make_move(22,5,Chess.Player.WHITE))
        # moving backwards
        self.assertFalse(self.test_white.make_move(34,50,Chess.Player.WHITE))
        # moving left or right
        self.assertFalse(self.test_white.make_move(34,33,Chess.Player.WHITE))
        self.assertFalse(self.test_white.make_move(34,35,Chess.Player.WHITE))
        # double move out of position white / Black
        self.assertFalse(self.test_white.make_move(34,3,Chess.Player.WHITE))
        self.assertFalse(self.test_black.make_move(33,65,Chess.Player.BLACK))
# test for knight
    def test_move_knight_valid(self):
        # some jumps
        self.assertTrue(self.test_white.make_move(68,35,Chess.Player.WHITE))
        self.setUp()
        self.assertTrue(self.test_white.make_move(68,37,Chess.Player.WHITE))
        self.setUp()
        self.assertTrue(self.test_white.make_move(68,50,Chess.Player.WHITE))

    def test_move_knight_invalid(self):
        # some invalid jumps
        self.assertFalse(self.test_black.make_move(68,36,Chess.Player.BLACK))
        self.assertFalse(self.test_black.make_move(68,52,Chess.Player.BLACK))
        self.assertFalse(self.test_black.make_move(68,2,Chess.Player.BLACK))
# test for Rook
    def test_move_rook_valid(self):
        self.assertTrue(self.test_black.make_move(0,1,Chess.Player.BLACK))
        self.setUp()
        self.assertTrue(self.test_black.make_move(0,2,Chess.Player.BLACK))
        self.setUp()
        self.assertTrue(self.test_black.make_move(7,39,Chess.Player.BLACK))

    def test_move_rook_invalid(self):
        # something is in the way
        self.assertFalse(self.test_black.make_move(0,6,Chess.Player.BLACK))
        # moving diagonal
        self.assertFalse(self.test_black.make_move(0,17,Chess.Player.BLACK))
# test for queen
    def test_move_queen_valid(self):
        # straight hitting something
        self.assertTrue(self.test_white.make_move(119,55,Chess.Player.WHITE))
        self.setUp()
        # straight hitting nothing
        self.assertTrue(self.test_white.make_move(119,71,Chess.Player.WHITE))
        self.setUp()
    ...
    def test_move_queen_invalid(self):
        ...
        self.assertFalse(self.test_white.make_move(119,49,Chess.Player.WHITE))
        # moving that way not possible
        self.assertFalse(self.test_white.make_move(119,2,Chess.Player.WHITE))
    ...
    @unittest.skip
    def test_check(self):
        self.test_black.make_move(19, 64, Chess.Player.BLACK)
        self.test_black.print_board()
        self.test_black.make_move(19, 49, Chess.Player.BLACK)
        self.test_black.print_board()
